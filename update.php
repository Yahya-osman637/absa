  ...
  <main class="mt-5 pt-3">
    <div class="container-fluid">
      ...
      if (isset($_POST['kudar'])) {
        ...
        $sql = "UPDATE tblpatients SET Fname='$fname', Mname='$Mname',Lname='$Lname',ContactNo='$ContactNo',Registration='$Registration',Total='$Total',Paid='$Paid',status='$status',bill='$bill' WHERE PatientID='$id'";
              ...
              <div class="card-body">
                <form method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="ContactNo" type="number" value="<?php echo $row['ContactNo'] ?>">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="Paid" type="text" value="<?php echo $row['Paid'] ?>">
                  </div>
<div class="mt-3 mb-3">
<select class="form-control" name="status" id="status">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="bill" rows="6" cols="45"
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-lg" name="kudar"><i
                        ...
                        <a class="btn btn-small btn-success" href="dashboard.php">Back</a>
                  </div>
