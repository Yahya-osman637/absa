        ...
        <thead>
          <tr>
            ...
            <th class="" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 0px; "
              aria-label="Position: activate to sort column ascending">Client Name
            </th>
            <th class="sorting dtr-hidden" tabindex="0" aria-controls="example" rowspan="1" colspan="1"
              style="width: 0px;" aria-label="Office: activate to sort column ascending"> Amount
            </th>
          ...
          <tr>
            ...
            <td class="dt-body-right dtr-hidden" style="">
              ...
              <a class="btn btn-small btn-success" href="pri.php?id=<?php echo $row['No']; ?>">Print</a>
